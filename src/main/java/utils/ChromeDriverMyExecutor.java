...
public class ChromeDriverMyExecutor extends DriverMyExecutor{
    ...
    private static final String CHROME_LINUX_64_PATH = "src/test/drivers/chrome/chromedriver_Linux64";
